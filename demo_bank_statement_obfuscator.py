...
Usage:
    python demo_bank_statement_obfuscator.py [--use-existing-sample]
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if models:
                ...
                logger.warning("You may need to run: ollama pull mistral:7b-instruct")
        else:
        ...
        logger.warning("Then pull the required model: ollama pull mistral:7b-instruct")
